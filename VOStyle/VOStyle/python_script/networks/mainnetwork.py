...
from python_script.mypath import Path
from python_script.networks.backbone import build_backbone
from python_script.networks.CoarseNet import CoarseNet
from python_script.networks.FineNet import FineNet

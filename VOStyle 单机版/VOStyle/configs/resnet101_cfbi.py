...
class Configuration():
    def __init__(self):
        ...
        self.DIR_ROOT = './'
        self.DIR_DATA = os.path.join(self.DIR_ROOT, 'work_folder')
        self.DIR_DAVIS = os.path.join(self.DIR_DATA, 'DAVIS')  # no use
        self.DIR_YTB = os.path.join(self.DIR_DATA, 'YTB/train')  # no use
        self.DIR_YTB_EVAL = self.DIR_DATA

        self.DIR_RESULT = os.path.join(self.DIR_DATA, 'segmentation_results')
